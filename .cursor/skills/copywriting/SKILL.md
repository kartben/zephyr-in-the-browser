...
- In **prose**, use lowercase for ordinary nouns: board, app, sample, device dock, terminal, peripheral.
- Match the **on-screen label** only when you are pointing at that control ("open Trace", "the board picker"). Do not capitalize board/app/dock everywhere for emphasis.
- Product name stays title case: Zephyr in the Browser. Instrument row names stay as labeled: Trace, Debug, Simulation.
...
- In-page help that teaches Zephyr, not the emulator internals
