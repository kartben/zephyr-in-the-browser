 ...
 * register-map UI and {@link createSensorChip}'s poke/setField path share these
 * so a JSON map and a TypeScript declaration decode the same way.
 */

import type { FieldDecl } from './model'
